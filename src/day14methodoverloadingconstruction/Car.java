...
public class Car {
	...
	public static void main(String[] args) {
		...
		Car car02 = new Car("Honda", 15000, 2019, "CR-V", "Red");
		...
		Car car03 = new Car("Lexus", 22000, 2020, "RC");
		...
		//(Bir sınıf değişkeninin değerine bakmak istediğinizde nesneleri kullanmanıza gerek yoktur.)
